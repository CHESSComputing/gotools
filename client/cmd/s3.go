...
func s3Usage() {
	...
	fmt.Println("client s3 upload Cornell/bucket file.txt")
	fmt.Println("\n# upload all files from given directory to a bucket:")
	fmt.Println("client s3 upload Cornell/bucket someDirectory")
	fmt.Println("\n# list content of s3 storage:")
	fmt.Println("client s3 ls Cornell")
	fmt.Println("\n# list specific bucket on s3 storage:")
	fmt.Println("client s3 ls Cornell/bucket")
}
