...
build_darwin_amd64:
	...
	tar cfs tools_darwin_amd64.tar.gz enc/enc foxden/foxden validator/validator
...
build_darwin_arm64:
	...
	tar cfs tools_darwin_arm64.tar.gz enc/enc foxden/foxden validator/validator

build_linux_amd64:
	cd enc; GOOS=linux go build; cd -
	cd foxden; 	GOOS=linux make; cd -
	cd validator; GOOS=linux go build; cd -
	tar cfs tools_linux_amd64.tar.gz enc/enc foxden/foxden validator/validator
...
build_linux_power8:
	...
	tar cfs tools_linux_power8.tar.gz enc/enc foxden/foxden validator/validator
...
build_windows_amd64:
	...
	tar cfs tools_windows_amd64.tar.gz enc/enc* foxden/foxden* validator/validator*
...
build_windows_arm64:
	...
	tar cfs tools_windows_arm64.tar.gz enc/enc* foxden/foxden* validator/validator*
